...
const Blog_category = () => {
  const { data, isLoading } = useGetAllMenusQuery({ limit: 10 });
          ...
          <div key={item}>
            <div className="w-full group flex items-center">
              <h2
                ...
                className="bg-[#f3f2f2] cursor-pointer flex items-center gap-x-2 text-black font-semibold text-xl group-hover:text-primary-orange flex-1 px-5 py-4"
              >
                <FaBowlFood className="text-xl group-hover:text-primary-orange text-black" />
                {item.name}
              </h2>
              <div>
