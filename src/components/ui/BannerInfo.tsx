...
const BannerInfo = () => {
  return (
    <div className="bg-primary-orange">
      ...
      <div className="container grid grid-cols-1 md:grid-cols-3 gap-y-[40px]">
        {data.map((item) => (
...
const BannerInfoCard = ({ info }: { info: Info }) => {
  return (
    <div className="mx-auto flex flex-col justify-center items-center max-w-[300px]">
      <Image src={info.icon} height={100} width={100} alt="icon" />
      <h1 className="text-[#121619] font-narrow uppercase font-bold text-[30px] text-center">
        {info.title}
      </h1>
