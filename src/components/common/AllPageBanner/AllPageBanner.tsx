            ...
            <div className="lg:text-5xl md:text-4xl text-3xl text-white font-bold absolute top-1/2 -translate-x-1/2  -translate-y-1/2  left-1/2">
                <div className="flex justify-center items-center flex-col">
                    ...
                    <Breadcrumb className="md:pt-4 pt-3">
                        <BreadcrumbList>
                            <BreadcrumbItem>
                                <BreadcrumbLink className="text-white hover:text-white font-normal  text-base" href="/">Home</BreadcrumbLink>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator />
                            <BreadcrumbItem >
                                <BreadcrumbPage className="text-white text-base font-normal">{activelink}</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
