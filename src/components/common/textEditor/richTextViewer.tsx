...
const RichTextViewer = ({
  ...
  // Function to clean HTML content by removing empty tags
  ...
  const displayContent =
    type === "card" ? getFirst100Words(content) : cleanHTMLContent(content);

  // Initialize the editor with the cleaned and truncated content
