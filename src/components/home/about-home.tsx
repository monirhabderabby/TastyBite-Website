...
const AboutHome = () => {
    ...
    return (
        <div className="my-6 md:my-20 container mx-auto" ref={ref}>
            <div className="flex flex-col md:flex-row items-center justify-between xl:justify-center gap-6 xl:gap-80">
                ...
                >
                    ...
                    <p className="text-sm mb-6 text-primary-black max-w-[480px] text-center md:text-left">
                        Founded on a passion for delivering not just foods, but
                        memorable moments, TastyBite is more than a food
                        ...
                        extraordinary foods, where every slice is an invitation
                        to culinary delight.
                    </p>
                    <Link href={"/about"}>
