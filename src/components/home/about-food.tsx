          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <p className="text-sm mb-6 md:mb-2 lg:mb-6 text-primary-black/75 max-w-[480px] text-left">
                ...
                crafted with fresh, high-quality Experience quick and efficient
                service that ensures your food is served fresh It&apos;s the
                dining experience where every dish is crafted with fresh,
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-primary-black/75 text-xs xl:text-sm leading-5 md:leading-4 lg:leading-5">
                      A team of dreamers and doers build unique interactive art
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-primary-black/75 text-xs xl:text-sm leading-5 md:leading-4 lg:leading-5">
                      A team of reputed dreamers and doers build unique
                      interactive art
                    </p>
                  </div>
                </div>
